...
parser.add_argument('-s', '--save-directory', type=str,
                    default='../saved_checkpoints_bis/exp3/',
                    help='path to save directory')
parser.add_argument('-lshift', '--lambda-shift-frac', default=3, type=float,
...
parser.add_argument('--resume', default='/content/drive/My Drive/CompVis_Project/pygoturn-master/model/pytorch_goturn.pth.tar', type=str, metavar='PATH',
                    help='path to latest checkpoint (dnoneefault: )')
